...
class CadastroComodosPage extends BasePage {
  @override
  State<StatefulWidget> createState() => _CadastroComodosPageState();
}

class _CadastroComodosPageState extends BasePageState<CadastroComodosPage> {
  ImagensComodos? selectedImage = ImagensComodos.plantaCasa;

  final titleController = TextEditingController();
  final imageController = TextEditingController();

//  pageTitle = 'Criar cômodo'
